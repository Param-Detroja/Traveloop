...
import { Share2, Copy, Send, Instagram, MessageCircle, Calendar, MapPin, Globe, Sparkles, ChevronLeft } from 'lucide-react';
  ...
  return (
    <div className="bg-[#050B18] min-h-screen text-white font-sans pb-32">
      <div className="max-w-4xl mx-auto px-6 pt-12">
        ...
        {/* Banner */}
        <div className="bg-[#fbbf24]/10 border border-[#fbbf24]/30 rounded-full px-8 py-3 mb-10 flex items-center justify-center gap-3 w-fit mx-auto">
